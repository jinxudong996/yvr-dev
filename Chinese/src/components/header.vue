  ...
  <div>
    ...
    <div class="allTop" id="header">
      <div class="w_1760 allTopCon">
        <div class="allTopLogo"><a href="#"><img src="../../static/images/logo111.png?ac=111" alt="" /></a></div>
        ...
        <div class="allTopConRig">
          ...
          <div class="allTopConRig_1" @click="goLogin()" v-show="loginStatus == 0"><a href="#">注册</a></div>
    ...
    methods: {
      ...
      goPath(flag){
        ...
        if(flag == 0){
          ...
          let dev = 'https://apitest.yvrdream.com/yvrdoc/vrcc/Support/PlatformFAQ.html'
          let uat = 'https://apiuat.yvrdream.com/yvrdoc/vrcc/Support/PlatformFAQ.html'
          let pro = 'https://developer.pfdm.cn/yvrdoc/vrcc/Publish/ApplicationLifecycle.html'
          if(this.envi == 'dev'){
            window.open(dev)
          }else if(this.envi == 'uat'){
